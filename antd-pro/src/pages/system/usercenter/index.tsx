...
class Usercenter extends Component<UsercenterProps, UsercenterState> {
  ...
  //   props: systemAndusercenterProps,
  //   state: systemAndusercenterState,
  // ) {
  ...
  componentDidMount() {
    ...
    dispatch({
      type: 'systemAndusercenter/fetchCurrent',
    });
    dispatch({
      type: 'systemAndusercenter/fetch',
    });
  }
...
export default connect(
  ({
    ...
    systemAndusercenter: ModalState;
  }) => ({
    currentUser: systemAndusercenter.currentUser,
    currentUserLoading: loading.effects['systemAndusercenter/fetchCurrent'],
  }),
)(Usercenter);
